...
data_path = '../iemocap_data'
model_output_path = "../wav2vec2_vad_iemocap_final_fp16"
# ---------------------------------------------------------
...
with open(f'{data_path}/train_vad_ready.json') as f:
    train_data = json.load(f)

with open(f'{data_path}/test_vad_ready.json') as f:

...
# --- CONFIGURATION ---
INPUT_JSON = "/path/to/SpeechCueLLM-main/IEMOCAP_data/test.json"          # Your input file
OUTPUT_JSON = "/path/to/SpeechCueLLM-main/IEMOCAP_data_ASR/test.json" # The final output file
...
#        )
        ...
        output = jiwer.process_words(ground_truth, result["text"])
